...
const newListItemButtonCancel = document.querySelector(
  "#new-list-button-cancel",
);
...
const newTaskTitle = newTaskDialog.querySelector(
  'input[name="new-task-title"]',
);
const newTaskDescription = newTaskDialog.querySelector(
