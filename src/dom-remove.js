...
const removeListDialogCancel = document.querySelector(
  "#remove-list-dialog-button-cancel",
);
const removeListDialogConfirm = document.querySelector(
  "#remove-list-dialog-button-confirm",
);
...
export function openRemoveListDialog(activeList) {
  ...
  removeListDialogText.textContent =
    "Are you sure you want to remove " + activeList + " and all of it's tasks?";
...
const removeTaskDialogCancel = document.querySelector(
  "#remove-task-dialog-button-cancel",
);
const removeTaskDialogConfirm = document.querySelector(
  "#remove-task-dialog-button-confirm",
);
