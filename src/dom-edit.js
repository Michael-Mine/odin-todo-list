import {
  lists,
  tasks,
  changeListNameInLists,
  changeListNameInTasks,
  editTask,
} from "./app-logic";
import {
  changeActiveList,
...
const editListNameDialogText = document.querySelector(
  "#edit-list-name-dialog-text",
);
const editListNameButtonChange = document.querySelector(
  "#edit-list-name-button-confirm",
);
const editListNameButtonCancel = document.querySelector(
  "#edit-list-name-button-cancel",
);
...
const editTaskButtonConfirm = document.querySelector(
  "#edit-task-button-confirm",
);

const editTaskTitle = editTaskDialog.querySelector(
  'input[name="edit-task-title"]',
);
